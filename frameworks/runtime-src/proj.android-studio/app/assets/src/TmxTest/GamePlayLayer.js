...
var GamePlayLayer = cc.Layer.extend({
    ...
    initData: function()
    {
        ...
        var sex = sexControl.initData(curDataBase, false);
        console.log("sex: " + JSON.stringify(sex));

        this._hero = biologyControl.getNewInstance(curDataBase, 1);

        languageControl.initLanguage(curDataBase);
        attributeImageControl.initAttributeImage(curDataBase);
        itemControl.initItemData(curDataBase);
    ...
    {
        // 创建 hero
        this._pPlayerSprite = cc.Sprite(res.Player);
        ...
        this._pCatcherSprite = new cc.Sprite(res.Player);
        // 获取追赶精灵在地图中的位置
